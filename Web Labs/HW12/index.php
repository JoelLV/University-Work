    ...
    <body>
        ...
        <?php
            ...
            if(isset($_POST['Login'])){
                $valid_user = passcheck($_POST['username'], $_POST['password']);
                if($valid_user == true){
            ...
            if(isset($_SESSION['loggedin'])){
                print("<h1>COVID-19 Temperature Check Stations (Highlighted Stations are available)</h1>");
                ...
                print("<input type=\"submit\" name=\"Add\" value=\"Add new session\"><br /><br />");
                ...
                if(!$valid_user and isset($_POST['Login'])){
                    print("Invalid username or password<br />");
                }
                print("<form method=\"post\" action=\"\">");
                print("Username: <input type=\"text\" name=\"username\"><br />");
                print("Password: <input type=\"password\" name=\"password\"><br />");
                print("<input type=\"submit\" name=\"Login\" value=\"Submit\"><br />");
                print("</form>");
            }
        ?>
    </body>
